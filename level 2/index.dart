void main() {
  ...
  for (String row in rows) {
    ...
    int game = int.parse(temp[0].trim().split(" ")[1]);
    ...
    for (String cubes in bags) {
      List<String> cube = cubes.split(", ");
      for (String item in cube) {
        List<String> items = item.trim().split(" ");
        int amount = int.parse(items[0]);
